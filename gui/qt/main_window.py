...
class ElectrumWindow(QMainWindow):
    ...
    def __init__(self, config, network, gui_object, actuator=None):
        ...
        tabs.addTab(self.create_addresses_tab(), self.actuator.get_icon("tab_addresses.png"), _('Addresses') )
        tabs.addTab(self.create_contacts_tab(), self.actuator.get_icon("tab_contacts.png"), _('Contacts') )
        tabs.addTab(self.create_invoices_tab(), self.actuator.get_icon("tab_invoices.png"), _('Invoices') )
        tabs.addTab(self.create_console_tab(), self.actuator.get_icon("tab_console.png"), _('Console') )
        tabs.setMinimumSize(600, 400)
        tabs.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        # we want a little extra vertical room for the icons
    ...
    def load_wallet(self, wallet):
        ...
        title = 'Encompass ' + self.wallet.electrum_version + '  -  ' + self.wallet.storage.path
    ...
    def init_menubar(self):
        ...
        # TODO replace when working plugins are confirmed
        ...
        help_menu.addAction(_("&Official website"), lambda: webbrowser.open("http://maza.club/encompass"))
    ...
    def show_report_bug(self):
        QMessageBox.information(self, "Encompass - " + _("Reporting Bugs"),
            _("Please report any bugs as issues on github:")+" <a href=\"https://github.com/mazaclub/encompass/issues\">https://github.com/mazaclub/encompass/issues</a>")
...
#        grid.addWidget(self.amount_help, row, 6)
    ...
    def read_send_tab(self):
        ...
        for type, addr, amount in outputs:
            if addr is None:
                QMessageBox.warning(self, _('Error'), _('Coin Address is None'), _('OK'))
                return
            if type == 'op_return':
                continue
    ...
    def show_invoice(self, key):
        from chainkey.paymentrequest import PaymentRequest
