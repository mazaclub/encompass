...
try:
    ...
    print "You need to have PyQT installed to run Encompass in graphical mode."
...
class MiniWindow(QDialog):
    ...
    def set_balances(self, btc_balance):
        ...
        self.setWindowTitle("Encompass %s - %s %s" % (electrum_version, amount, unit))
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        ...
        self.setWindowTitle("Encompass - " + _("Receive Bitcoin payment"))
...
class MiniActuator:
    ...
    def set_configured_currency(self, set_quote_currency):
        ...
        # currency can be none when Encompass is used for the first
